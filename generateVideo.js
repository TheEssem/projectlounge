  ...
  return new Promise((resolve, reject) => {
    ...
    ffmpeg.ffprobe(options.buffer ? probeStream : options.file, (error, metadata) => {
      ...
      const filters = [{
        ...
        filter: "drawtext",
        options: {
          fontfile: `'${path.dirname(url.fileURLToPath(import.meta.url))}/assets/DejaVuSans.ttf'`,
          text: "@this_vid2",
          fontcolor: "white",
        ...
        filter: "drawtext",
        options: {
          fontfile: `'${path.dirname(url.fileURLToPath(import.meta.url))}/assets/DejaVuSans-Bold.ttf'`,
        ...
        filter: "drawtext",
        options: {
          fontfile: `'${path.dirname(url.fileURLToPath(import.meta.url))}/assets/Topaz.ttf'`,
